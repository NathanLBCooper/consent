...
namespace Consent.Api
{
    internal static class Dependencies
    {
        ...
        {
            RegisterByConvention(typeof(Consent.Storage.Organizations.OrganizationRepository).Assembly, container, t => t.Name.EndsWith("Repository"));
            RegisterByConvention(typeof(Consent.Domain.Accounts.OrganizationEndpoint).Assembly, container, t => t.Name.EndsWith("Endpoint"));
